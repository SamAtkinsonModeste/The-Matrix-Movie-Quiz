const matrixCharacters = [ {
	...
	answers: [ {
		...
		options: `<li class="align-center"><input class="wrong" type="radio" id="the-oracle" name="character" value="The Oracle"><label for="the-oracle"> The Oracle </label></li>`
	}, {
	...
	answers: [ {
		...
		options: `<li class="align-center"><input class="wrong" type="radio" id="oracle" name="character" value="Oracle"><label for="oracle"> The Oracle </label></li>`
	}, {
	...
	answers: [ {
		options: `<li class="align-center"><input class="wrong" type="radio" id="keymaker" name="character" value="Keymaker"><label for="keymaker"> Keymaker </label></li>`
	}, {
		options: `<li class="align-center"><input class="correct" type="radio" id="oracle" name="character" value="Oracle"><label for="oracle"> The Oracle </label></li>`
	}, {
		options: `<li class="align-center"><input class="wrong" type="radio" id="morpheus" name="character" value=" Morpheus"><label for="morpheus"> Morpheus </label></li>`
	}, {
		options: `<li class="align-center"><input class="wrong" type="radio" id="cypher" name="character" value="Cypher"><label for="cypher"> Cypher </label></li>`
	...
	answers: [ {
		...
		options: `<li class="align-center"><input  class="wrong" type="radio" id="mr-anderson" name="character" value="Mr Anderson"><label for="mr-anderson">Mr Anderson</label></li>`
	}, ]
}, {
	...
	answers: [ {
		...
		options: `<li class="align-center"><input class="wrong" type="radio" id="councillar-hamann" name="character" value="Councillar Hamann"><label for="councillar-hamann">Counicllar Hamann </label></li>`
	}, {
	...
	answers: [ {
		options: `<li class="align-center"><input  class="wrong" type="radio" id="councillar-hamann" name="character" value="Councillar Harmann"><label for="councillar-hamann"> Councillar Hamann </label></li>`
	}, {
		options: `<li class="align-center"><input class="wrong" type="radio" id="agent-brown" name="character" value="Agent Brown"><label for="agent-brown"> Agent Brown </label></li>`
	}, {
