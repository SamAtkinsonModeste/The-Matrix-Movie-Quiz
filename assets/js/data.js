const levelOne = [
    {
       ...
       answers: [
        {options: `<li><label for="cypher"> Cypher <input type="radio" id="cypher" name="character" value="Cypher"></label></li>`}, 
         {options: `<li><label for="agent-smith"> Agent Smith <input class="correct" type="radio" id="agent-smith" name="character" value="Agent-smith"></label></li>`} , 
         {options: `<li><label for="neo"> Neo <input type="radio" id="neo" name="character" value="Neo"></label></li>`},
         {options: `<li><label for="apoc"> Apoc <input type="radio" id="apoc" name="character" value="Apoc"></label></li>`},
    ...
    },
    {
        ...
        answers: [
            {options: `<li><label for="tank"> Tank <input type="radio" id="tank" name="character" value="Tank"></label></li>`}, 
             ...
             {options: `<li><label for="apoc"> Apoc <input class="correct" type="radio" id="apoc" name="character" value="Apoc"></label></li>`},   
